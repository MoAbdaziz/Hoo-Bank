...
<div className='flex-1 flex flex-col ml-3'>
  <h4 className='font-poppins font-semibold mb-1 text-white text-[18px] leading-[23px]'>{title}</h4>
  <p className='font-poppins font-normal mb-1 text-dimWhite text-[16px] leading-[24px]'>
    {content}
  </p>
